...
| ROI | revenue / spend | 业务目标 |

## Data Quality Rules

- 不同平台归因不能直接相加为真实业务收入，除非有去重口径。
- Google Ads conversions、GA4 events、CRM revenue 要分开标注来源。
