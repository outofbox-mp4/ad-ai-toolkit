...
Obtain product truth, offer, desired action, target audience, funnel stage, market, placement, brand constraints, compliance rules, and performance evidence. Identify assumptions explicitly when evidence is absent.

## Build the brief

1. State one audience tension or job to be done.
2. Translate product proof into a single-message proposition.
3. Create 3–5 distinct testable angles, not superficial copy variations.
...
- Avoid targeting or copy that exploits sensitive traits or vulnerable audiences.
- Request legal or brand review for regulated categories, comparative claims, and performance promises.
